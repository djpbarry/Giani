...
//    private final ExecutorService exec = Executors.newFixedThreadPool(Runtime.getRuntime().availableProcessors());
    ...
    private void initComponents() {
        ...
        nuclearCentreFinderPanel = new ui.MaximaFinderPanel(props,img,maximaFinder,
        ...
        nuclearFilteringPanel = new ui.FilteringPanel(props,img, nucGaussFilter,
    ...
    cellFilteringPanel = new ui.FilteringPanel(props,img, cellGaussFilter,
    ...
    protected boolean addAdditionalBlobDetectionPanels() {
        ...
        for (int i = 0; i < n; i++) {
            if ((channels & (int) Math.pow(2.0, i)) != 0) {
                ...
                propLabels[MultiThreadedMaximaFinder.HESSIAN_DETECT] = String.format("%s%d", GianiDefaultParams.FOCI_MAXIMA_DETECT_EDM_MAXIMA, i);
                propLabels[MultiThreadedMaximaFinder.HESSIAN_STOP_SCALE] = String.format("%s%d", GianiDefaultParams.FOCI_MAXIMA_DETECT_EDM_MAX_SIZE, i);
                propLabels[MultiThreadedMaximaFinder.HESSIAN_START_SCALE] = String.format("%s%d", GianiDefaultParams.FOCI_MAXIMA_DETECT_EDM_MIN_SIZE, i);
